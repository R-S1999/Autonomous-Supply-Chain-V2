...
import { renderSense } from './tabs/sense.js?v=longmont';
import { renderSimulate } from './tabs/simulate.js?v=longmont';
import { renderIntervene } from './tabs/intervene.js?v=longmont';
import { renderAct } from './tabs/act.js?v=bpm3';
