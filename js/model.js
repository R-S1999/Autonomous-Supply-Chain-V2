...
export const INTERVENTION_AGENT_STEPS = {
  ...
  prioritize_longmont_oil_allocation: [
    ...
    ['cold_dc_west', 'WMS', 'Reserve recovered finished goods and sequence deployment by retailer priority.'],
    ['retailer_costco', 'OMS', "Lock Costco and Sam's Club orders into the protected schedule."],
  ],
};
